 /**
* @class LogMSLine2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* LogMSLine2DChart chart extends the LogYAxisChart class to render a
* Logarithmic Axis Multi-series 2D Line Chart.
*/
//Import Chart class
import com.fusioncharts.core.Chart;
//Parent LogYAxisChart Class
...
class com.fusioncharts.core.charts.LogMSLine2DChart extends LogYAxisChart 
{
	...
	*/
	function LogMSLine2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Logarithmic Axis Multi Series 2D Line Chart", Logger.LEVEL.INFO);
		//List Chart Objects and set them
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "VDIVLINES", "YAXISVALUES", "VGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOT", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND");
	...
	*/
	public function render () : Void 
	{
		...
		} else 
		{
			...
			//Update timer
			this.timeElapsed += (this.params.animation && (this.params.showAlternateHGridColor || this.params.showAlternateVGridColor)) ? this.styleM.getMaxAnimationTime (this.objects.VGRID) : 0;
			//Draw labels
	...
	*/
	private function returnDataAsObject (value : Number, color : String, alpha : Number, toolText : String, link : String, showValue : Number, isDashed : Boolean, anchorSides : Number, anchorRadius : Number, anchorBorderColor : String, anchorBorderThickness : Number, anchorBgColor : String, anchorAlpha : Number, anchorBgAlpha : Number) : Object 
	{
		...
		dataObj.isDefined = ((dataObj.alpha == 0) || isNaN (value) || value == 0) ? false : true;
	...
	private function calculatePoints ()
	{
		...
		for (i = 1; i <= this.numDS; i ++)
		{
			...
			for (j = 1; j <= this.num; j ++)
			{
				...
				//Set the y position
				this.dataset [i].data [j].y = this.getAxisPosition (this.dataset [i].data [j].value, null, null, this.elements.canvas.y, this.elements.canvas.toY, true, 0);
