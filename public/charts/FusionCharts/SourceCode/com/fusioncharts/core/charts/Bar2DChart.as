...
class com.fusioncharts.core.charts.Bar2DChart extends SingleYAxis2DHorizontalChart 
{
	...
	*/
	function Bar2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "VGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOT", "TOOLTIP", "VLINES");
	...
	*/
	private function calcVLinesPos ()
	{
		...
		for (i = 1; i <= numVLines; i ++)
		{
			...
			{
				//Set it's y position
				this.vLines [i].y = this.data [this.vLines [i].index].y + (this.data [this.vLines [i].index + 1].y - this.data [this.vLines [i].index].y) / 2;
			} else 
			{
				//Invalidate it
