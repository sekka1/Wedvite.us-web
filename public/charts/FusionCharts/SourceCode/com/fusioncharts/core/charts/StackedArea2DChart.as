 /**
* @class StackedArea2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* StackedArea2DChart chart extends the SingleYAxis2DVerticalChart class to render a
...
class com.fusioncharts.core.charts.StackedArea2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function StackedArea2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Stacked 2D Area Chart", Logger.LEVEL.INFO);
	...
	*/
	private function returnDataAsObject (value : Number, color : String, alpha : Number, toolText : String, link : String, showValue : Number, isDashed : Boolean, anchorSides : Number, anchorRadius : Number, anchorBorderColor : String, anchorBorderThickness : Number, anchorBgColor : String, anchorAlpha : Number, anchorBgAlpha : Number) : Object 
	{
		...
		//Now, if the data is not defined, we set value to 0 (as it's stacked).
		dataObj.value = (dataObj.isDefined == true) ?dataObj.value : 0;
		//Other parameters
	...
	*/
	private function calculatePoints ()
	{
		...
		{
			//All negative numbers - so set basePlanePos as 0 value
		...
		for (i = 1; i <= this.numDS; i ++)
		{
			for (j = 1; j <= this.num; j ++)
			{
				...
				//Set the y position
				this.dataset [i].data [j].y = this.getAxisPosition (this.dataset [i].data [j].cumValue, this.config.yMax, this.config.yMin, this.elements.canvas.y, this.elements.canvas.toY, true, 0);
