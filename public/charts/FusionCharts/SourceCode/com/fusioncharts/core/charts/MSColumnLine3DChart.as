 /**
* @class MSColumnLine3DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* MSColumnLine3DChart chart extends the SingleYAxis3DChart class to render a
* Mult-series 3D Column + Multi-series Line Combination Chart.
*/
//Import Chart class
import com.fusioncharts.core.Chart;
//Parent SingleYAxis3DChart Class
import com.fusioncharts.core.SingleYAxis3DChart;
//Error class
...
class com.fusioncharts.core.charts.MSColumnLine3DChart extends SingleYAxis3DChart 
{
	...
	*/
	function MSColumnLine3DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Multi Series 3D Column Line Combination Chart", Logger.LEVEL.INFO);
		//List Chart Objects and set them
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "DATALABELS", "DATAVALUES", "LEGEND", "TRENDLINES", "TRENDVALUES", "DATAPLOTCOLUMN", "DATAPLOTLINE", "TOOLTIP", "VLINES", "ANCHORS");
		...
		for (i = 1; i <= this.num; i ++)
		{
			...
			for (j = 1; j <= this.numDS; j ++)
			{
				...
				if (this.dataset [j].renderAs == "COLUMN")
				{
					...
					dataEndY = this.getAxisPosition (this.dataset [j].data [i].value, this.config.yMax, this.config.yMin, this.elements.canvasBg.y, this.elements.canvasBg.toY, true, 0);
		...
		for (i = 1; i <= this.numDS; i ++)
		{
			if (this.dataset [i].renderAs != "COLUMN")
			{
				for (j = 1; j <= this.num; j ++)
				{
					...
					//Set the y position
					this.dataset [i].data [j].y = this.getAxisPosition (this.dataset [i].data [j].value, this.config.yMax, this.config.yMin, this.elements.canvasBg.y, this.elements.canvasBg.toY, true, 0) + this.config.shifts.yShift;
					//Store value textbox y position
	...
	*/
	...
	/**
	* drawColumnValues method draws the values for the column chart.
	*/
	private function drawColumnValues () : Void
	{
		...
		for (i = 1; i <= this.numDS; i ++)
		{
			if (this.dataset [i].renderAs == "COLUMN")
			{
				for (j = 1; j <= this.num; j ++)
				{
					//If column, defined and value is to be shown
