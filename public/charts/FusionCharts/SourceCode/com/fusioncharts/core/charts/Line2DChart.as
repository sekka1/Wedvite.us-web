...
*
* Line2DChart chart extends the SingleYAxis2DVerticalChart class to render a
* 2D Line Chart.
*/
//Import Chart class
...
class com.fusioncharts.core.charts.Line2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function Line2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		*/
		...
		for (i = firstIndex; i < this.num; i ++)
		{
			...
			if (this.data [i].isDefined)
			{
				...
				{
					//Draw a dashed line
					DrawingExt.dashTo (chartMC, this.data [i].x, this.data [i].y, this.data [nxt].x, this.data [nxt].y, this.params.lineDashLen, this.params.lineDashGap);
				} else 
				{
					//Move to the point
