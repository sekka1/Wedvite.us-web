 /**
* @class MSSpline2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* MSSpline2DChart chart extends the SingleYAxis2DVerticalChart class to render a
...
class com.fusioncharts.core.charts.MSSpline2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function MSSpline2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Multi Series 2D Spline Chart", Logger.LEVEL.INFO);
