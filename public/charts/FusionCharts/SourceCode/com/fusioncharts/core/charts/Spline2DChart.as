...
*
* Spline2DChart chart extends the SingleYAxis2DVerticalChart class to render a
* 2D Spline Chart.
*/
//Import Chart class
...
class com.fusioncharts.core.charts.Spline2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function Spline2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Single Series 2D Spline Chart", Logger.LEVEL.INFO);
	...
	*/
	public function render () : Void 
	{
		...
		} else 
		{
			...
			//Draw line chart
			this.config.intervals.plot = setInterval (Delegate.create (this, drawSplineChart) , this.timeElapsed);
			//Update timer
			...
			if (arrDocElement [i].nodeName.toUpperCase () == "GRAPH" || arrDocElement [i].nodeName.toUpperCase () == "CHART")
			{
				...
				for (j = 0; j < arrLevel1Nodes.length; j ++)
				{
					...
					if (arrLevel1Nodes [j].nodeName.toUpperCase () == "SET")
					{
						...
						//TODO: Change FF5904 with a pertinent color derived from the single
						//color scheme. Or, probably from a list of colors.
	...
	*/
	private function setStyleDefaults () : Void 
	{
		...
		//TODO: Replace with categories font properties here.
	...
	*/
	private function calculatePoints ()
	{
		...
		//Now, store the positions of the plot points
		for (i = 1; i <= this.num; i ++)
		{
			//X-Position
	...
	*/
	...
	/**
	* drawSplineChart method draws the lines on the chart
	*/
	private function drawSplineChart () : Void 
	{
		/**
		...
		*/
		...
		for (i = firstIndex; i < this.num; i ++)
		{
			...
			if (this.data [i].isDefined)
			{
				...
				//Set line style
				chartMC.lineStyle (this.params.lineThickness, parseInt (this.data [i].color, 16) , this.data [i].alpha);
				//Move to the point
