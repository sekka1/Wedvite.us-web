...
class com.fusioncharts.core.charts.RadarChart extends SingleYAxisChart 
{
	...
	*/
	private function calculatePoints ()
	{
		...
		//Special case when there are total of three points (in that case, we access 2nd and 3rd label directly)
		//Because num/2 steps out of both loop
		if (this.num==3){
			//Create text field to get width
			var labelObj : Object = createText (true, this.categories [2].label, this.tfTestMC, 1, testTFX, testTFY, 0, labelFontObj, false, 0, 0);
			//Store the greater width
			maxLabelWLeft = labelObj.width;
			//Create text field to get width
			var labelObj : Object = createText (true, this.categories [3].label, this.tfTestMC, 1, testTFX, testTFY, 0, labelFontObj, false, 0, 0);
			//Store the greater width
			maxLabelWRight = Math.max (maxLabelWRight, labelObj.width);
			delete labelObj;
		}
