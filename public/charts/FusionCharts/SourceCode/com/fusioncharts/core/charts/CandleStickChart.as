...
class com.fusioncharts.core.charts.CandleStickChart extends Chart 
{
	...
	*/
	private function calcCanvasCoords ()
	{
		...
		//Now, accomodate width if either of the labels are to be shown
		if ((this.params.PYAxisName != "") || (this.params.VYAxisName != ""))
		{
	...
	*/
	private function calculatePoints () : Void
	{
		...
		var plotWidth : Number = (plotArea - plotSpace) / Math.max(this.numCat, this.num);
		...
		if (this.config.showVolume && ((plotWidth/2)>this.params.canvasPadding)){
			...
			plotWidth = (plotArea - plotSpace) / Math.max(this.numCat, this.num);
		}
