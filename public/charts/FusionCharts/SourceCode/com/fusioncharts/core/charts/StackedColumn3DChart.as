 /**
* @class StackedColumn3DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* StackedColumn3DChart chart extends the SingleYAxis3DChart class to render a
...
class com.fusioncharts.core.charts.StackedColumn3DChart extends SingleYAxis3DChart
{
	...
	*/
	function StackedColumn3DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Stacked 3D Column Chart", Logger.LEVEL.INFO);
	...
	*/
	private function drawColumns ()
	{
		...
		for (i = 1; i <= this.num; i ++)
		{
			...
			//Apply animation (only if column count > 0)
			if (this.params.animation && renderedColCount > 0)
			{
				...
				if (this.sums [i].pSum != undefined)
				{
					...
					this.styleM.applyAnimation (pStackMC, this.objects.DATAPLOT, this.macro, this.dataset [j].data [i].x, 0, this.dataset [j].data [i].y, 0, 100, 100, animY, null);
				}
				//Negative Stack
				if (this.sums [i].nSum != undefined)
				{
					...
					this.styleM.applyAnimation (nStackMC, this.objects.DATAPLOT, this.macro, this.dataset [j].data [i].x, 0, this.dataset [j].data [i].y, 0, 100, 100, animY, null);
				}
			}
