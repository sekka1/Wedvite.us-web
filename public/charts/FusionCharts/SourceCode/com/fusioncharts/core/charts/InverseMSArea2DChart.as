 /**
* @class InverseMSArea2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* InverseMSArea2DChart chart extends the InverseYAxis2DVerticalChart class to render an
...
class com.fusioncharts.core.charts.InverseMSArea2DChart extends InverseYAxis2DVerticalChart 
{
	...
	*/
	function InverseMSArea2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Inverse Axis Multi-Series 2D Area Chart", Logger.LEVEL.INFO);
