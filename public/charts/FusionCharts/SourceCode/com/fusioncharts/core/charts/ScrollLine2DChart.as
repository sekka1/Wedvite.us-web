...
*
* ScrollLine2DChart chart extends the SingleYAxis2DVerticalChart class to render a
* Multi-series 2D Line Chart with scrolling features
*/
//Import Chart class
...
class com.fusioncharts.core.charts.ScrollLine2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function ScrollLine2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Scroll Line 2D Chart", Logger.LEVEL.INFO);
		//List Chart Objects and set them
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "VDIVLINES", "YAXISVALUES", "HGRID", "VGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOT", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND", "SCROLLPANE");
