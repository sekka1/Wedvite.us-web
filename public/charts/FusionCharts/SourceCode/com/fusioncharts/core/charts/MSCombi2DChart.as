 /**
* @class MSCombi2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* MSCombi2DChart chart extends the SingleYAxis2DVerticalChart class to render a
* Multi-series Combination 2D Chart.
*/
//Import Chart class
...
class com.fusioncharts.core.charts.MSCombi2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function MSCombi2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Multi Series 2D Combination Chart", Logger.LEVEL.INFO);
		//List Chart Objects and set them
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "HGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOTCOLUMN", "DATAPLOTLINE", "DATAPLOTAREA", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND");
		...
		*/
		...
		for (m = 1; m <= this.numDS; m ++)
		{
			...
			if (this.dataset [m].renderAs == "AREA")
			{
				...
				if (this.params.animation)
				{
					this.styleM.applyAnimation (holderMC, this.objects.DATAPLOTAREA, this.macro, holderMC._x, 0, holderMC._y, 0, 100, 100, 100, null);
				}
				//Increment depth
				depth ++;
			}
