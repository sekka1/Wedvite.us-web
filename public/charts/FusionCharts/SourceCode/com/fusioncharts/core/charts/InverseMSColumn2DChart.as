 /**
* @class InverseMSColumn2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* MSColumn2DChart chart extends the InverseYAxis2DVerticalChart class to render an
* INVERSE Multi-series 2D Column Chart.
*/
//Import Chart class
import com.fusioncharts.core.Chart;
//Parent InverseYAxis2DVerticalChart Class
import com.fusioncharts.core.InverseYAxis2DVerticalChart;
//Error class
...
class com.fusioncharts.core.charts.InverseMSColumn2DChart extends InverseYAxis2DVerticalChart 
{
	...
	*/
	function InverseMSColumn2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Inverse Axis Multi Series 2D Column Chart", Logger.LEVEL.INFO);
	...
	*/
	private function calculatePoints ()
	{
		...
		{
			//No negative numbers - so set basePlanePos as yMax value
