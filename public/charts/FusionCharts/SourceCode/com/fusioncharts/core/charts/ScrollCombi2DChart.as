 /**
* @class ScrollCombi2DChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
*
* ScrollCombi2DChart chart extends the SingleYAxis2DVerticalChart class to render a
* Multi-series Combination 2D Chart with scrolling capabilities.
*/
//Import Chart class
...
class com.fusioncharts.core.charts.ScrollCombi2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	function ScrollCombi2DChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		...
		this.log ("Chart Type", "Scroll Combination 2D Chart", Logger.LEVEL.INFO);
		//List Chart Objects and set them
		_arrObjects = new Array ("BACKGROUND", "CANVAS", "CAPTION", "SUBCAPTION", "YAXISNAME", "XAXISNAME", "DIVLINES", "YAXISVALUES", "HGRID", "DATALABELS", "DATAVALUES", "TRENDLINES", "TRENDVALUES", "DATAPLOTCOLUMN", "DATAPLOTLINE", "DATAPLOTAREA", "ANCHORS", "TOOLTIP", "VLINES", "LEGEND", "SCROLLPANE");
			...
			if (arrDocElement [i].nodeName.toUpperCase () == "GRAPH" || arrDocElement [i].nodeName.toUpperCase () == "CHART")
			{
				...
				for (j = 0; j < arrLevel1Nodes.length; j ++)
				{
					...
					} else if (arrLevel1Nodes [j].nodeName.toUpperCase () == "DATASET")
					{
						...
						this.dataset [this.numDS].alpha = getFN (dsAtts ["alpha"] , (this.dataset [this.numDS].renderAs == "AREA" && this.params.areaOverColumns) ? (this.params.plotFillAlpha / 2) : (this.params.plotFillAlpha));
	...
	*/
	private function calculatePoints ()
	{
		...
		//Re-position base plane position w.r.t canvas start Y
			...
			for (i = 1; i <= this.num; i ++)
			{
				...
				for (j = 1; j <= this.numDS; j ++)
				{
					...
					if (this.dataset [j].renderAs == "COLUMN")
					{
						...
						dataEndY = this.getAxisPosition (this.dataset [j].data [i].value, this.config.yMax, this.config.yMin, this.elements.canvas.y, this.elements.canvas.toY, true, 0) - this.elements.canvas.y;
