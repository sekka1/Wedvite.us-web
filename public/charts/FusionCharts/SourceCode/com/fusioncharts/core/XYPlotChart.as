	...
	private function parseVTrendLineXML (arrTrendLineNodes : Array) : Void
	{
		...
		for (i = 0; i <= arrTrendLineNodes.length; i ++)
		{
			...
			if (arrTrendLineNodes [i].nodeName.toUpperCase () == "LINE")
			{
				...
				valueOnRight = false;
				//Create trend line object
				this.vTrendLines [numVTrendLines] = returnDataAsTrendObj (startValue, endValue, displayValue, color, thickness, alpha, isTrendZone, showOnTop, isDashed, dashLen, dashGap, valueOnRight);
			}
		}
	}
	/**
