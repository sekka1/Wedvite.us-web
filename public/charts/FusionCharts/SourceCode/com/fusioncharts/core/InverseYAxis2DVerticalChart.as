 /**
* @class InverseYAxis2DVerticalChart
* @author InfoSoft Global (P) Ltd. www.InfoSoftGlobal.com
* @version 3.0
*
* Copyright (C) InfoSoft Global Pvt. Ltd. 2005-2006
* InverseYAxis2DVerticalChart extends SingleYAxis2DChart class to encapsulate
* functionalities of a single series 2D chart with a single vertical INVERSE axes. All such
...
class com.fusioncharts.core.InverseYAxis2DVerticalChart extends SingleYAxis2DVerticalChart 
{
	//Instance variables
	/**
	...
	* constructor.
	*/
	function InverseYAxis2DVerticalChart (targetMC : MovieClip, depth : Number, width : Number, height : Number, x : Number, y : Number, debugMode : Boolean, lang : String, scaleMode:String, registerWithJS:Boolean, DOMId:String)
	{
		//Invoke the super class constructor
		super (targetMC, depth, width, height, x, y, debugMode, lang, scaleMode, registerWithJS, DOMId);
	}
	/**
	* This method OVER-RIDES the getAxisPosition method of SingleYAxisChart
	* class, as we're dealing with inverse axis here.
