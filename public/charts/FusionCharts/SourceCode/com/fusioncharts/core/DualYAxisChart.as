...
class com.fusioncharts.core.DualYAxisChart extends Chart 
{
	...
	*/
	private function returnDataAsTrendObj (parentYAxis : String, startValue : Number, endValue : Number, displayValue : String, color : String, thickness : Number, alpha : Number, isTrendZone : Boolean, showOnTop : Boolean, isDashed : Boolean, dashLen : Number, dashGap : Number) : Object 
	{
	...
	private function parseTrendLineXML (arrTrendLineNodes : Array) : Void 
	{
		...
		for (i = 0; i <= arrTrendLineNodes.length; i ++)
		{
			...
			if (arrTrendLineNodes [i].nodeName.toUpperCase () == "LINE")
			{
				...
				this.trendLines [numTrendLines] = returnDataAsTrendObj (parentYAxis, startValue, endValue, displayValue, color, thickness, alpha, isTrendZone, showOnTop, isDashed, dashLen, dashGap);
