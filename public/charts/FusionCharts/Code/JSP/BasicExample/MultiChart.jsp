...
<%
	...
	String chartCode= createChart("../../FusionCharts/Column3D.swf", "Data/Data.xml", "", "chart1", 600, 300, false, false);
%> 
<%=chartCode%> 
<BR>
<BR>
<%	
	...
	String chartCode2= createChart("../../FusionCharts/Column2D.swf", "Data/Data.xml", "", "chart2", 600, 300, false, false);
%> 
<%=chartCode2%> 
<BR>
<BR>
<%	
	...
	String chartCode3= createChart("../../FusionCharts/Line.swf", "Data/Data.xml", "", "chart3", 600, 300, false, false);
%> 
<%=chartCode3%> 
<BR>
<BR>
