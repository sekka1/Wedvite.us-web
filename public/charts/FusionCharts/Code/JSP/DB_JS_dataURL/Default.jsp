	...
	<HEAD>
		...
		<BODY>
			...
			<%		
				...
				String chartCode=createChart("../../FusionCharts/Pie3D.swf", "", strXML, "FactorySum", 500, 250, false, false);
			%> 
			<%=chartCode%> 
			<BR>
			<%
				...
				String chartCode2=createChart("../../FusionCharts/Column2D.swf?ChartNoDataText=Please select a factory from pie chart above to view detailed data.", "", "<chart></chart>", "FactoryDetailed", 600, 250, false, false);
			%> 
			<%=chartCode2%> 
			<BR>
			<BR>
