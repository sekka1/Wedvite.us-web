...
<head>
    ...
    <title>FusionCharts v3 - ASP.NET 2.0 C# Code Examples</title>
    <style type="text/css">
body{
 font-family:Verdana;
}
...
<body>
    <div align="center">
        <h4>
            <a href='http://www.fusioncharts.com' target='_blank'>FusionCharts v3 </a>- ASP.NET 2.0 C# Samples</h4>
    </div>
    <table width="600" border="0" cellspacing="3" cellpadding="3" style='border: 1px #CCCCCC solid;'
        ...
        <tr>
            <td>
                <b>Client Side Dynamic Chart Examples</b></td>
        </tr>
        <tr>
            <td>
                <ul>
		 ...
		 <tr>
            <td>
                <b>ASP.NET AJAX UpdatePanel Examples</b></td>
        </tr>
        <tr>
            <td>
                <ul>
