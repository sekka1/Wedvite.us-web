...
<%
	...
	Call renderChart("../../FusionCharts/Column3D.swf", "Data/Data.xml", "", "chart1", 600, 300, false, false)
%>
	<BR><BR>
<%	
	'Now, create a Column 2D Chart
	Call renderChart("../../FusionCharts/Column2D.swf", "Data/Data.xml", "", "chart2", 600, 300, false, false)
%>
	<BR><BR>
<%	
	'Now, create a Line 2D Chart
	Call renderChart("../../FusionCharts/Line.swf", "Data/Data.xml", "", "chart3", 600, 300, false, false)
%>
