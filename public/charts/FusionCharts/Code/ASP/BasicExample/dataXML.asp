...
<h4>Basic example using dataXML method (with XML data hard-coded in ASP page itself)</h4>
...
<%
	...
	Call renderChart("../../FusionCharts/Column3D.swf", "", strXML, "myNext", 600, 300, false, false)
%>
<BR><BR>
